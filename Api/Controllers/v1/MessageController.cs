...
public class MessageController : ControllerBase
{
    ...
    {
        IEnumerable<MessageResponse> messageList = await _messageService.GetAllMessages(lastUpdatedAt,isDeleted);
    ...
    [ProducesResponseType(200, Type = typeof(IEnumerable<MessageResponse>))]
    public async Task<ActionResult<MessageResponse>> GetMessageByOwnerId(string ownerId,DateTimeOffset? lastUpdatedAt,bool? isDeleted)
    {
        try
        {
            var messageList = await _messageService.GetMessageByOwnerId(ownerId,lastUpdatedAt,isDeleted);
            return Ok(messageList);
        }
        catch (Exception e)
        { 
    ...
    [ProducesResponseType(200, Type = typeof(IEnumerable<MessageResponse>))]
    public async Task<ActionResult<MessageResponse>> GetMessageByTopicId(string topicId, DateTimeOffset? lastUpdatedAt,bool? isDeleted)
    {
        try
        {
            var messageList = await _messageService.GetMessageByTopicId(topicId, lastUpdatedAt,isDeleted);
            return Ok(messageList);
        }
        catch (Exception e)
        { 
    ...
    [ProducesResponseType(200, Type = typeof(IEnumerable<MessageResponse>))]
    public async Task<ActionResult<MessageResponse>> GetMessageByTopicTypeAndTopicId(MessageTopicTypeEnum topicType, string topicId, DateTimeOffset? lastUpdatedAt,bool? isDeleted)
    {
        try
        {
            var messageList = await _messageService.GetMessageByTopicTypeAndTopicId(topicType, topicId, lastUpdatedAt,isDeleted);
            return Ok(messageList);
        }
        catch (Exception e)
        { 
    ...
    [ProducesResponseType(200, Type = typeof(IEnumerable<MessageResponse>))]
    public async Task<ActionResult<MessageResponse>> GetMessageByMessageTypeAndTopicId(MessageTypeEnum messageType, string topicId, DateTimeOffset? lastUpdatedAt,bool? isDeleted)
    {
        try
        {
            var messageList = await _messageService.GetMessageByMessageTypeAndTopicId(messageType, topicId, lastUpdatedAt,isDeleted);
            return Ok(messageList);
        }
        catch (Exception e)
        { 
