...
namespace domain.Repositories
{
	...
	{
		Task<IEnumerable<Compound>> GetAsync(DateTimeOffset? lastUpdatedAt);
        ...
        Task<IEnumerable<Compound>> GetAsyncByClientId(string clientId, DateTimeOffset? lastUpdatedAt);
    }
}
